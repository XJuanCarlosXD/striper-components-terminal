...
function fetchConnectionToken() {
  ...
  return fetch('http://127.0.0.1:4242/connection_token', { method: "POST" })
...
function fetchPaymentIntentClientSecret(amount) {
  ...
  return fetch('http://127.0.0.1:4242/create_payment_intent', {
    method: "POST",
    headers: {
...
function capture(paymentIntentId) {
  return fetch('http://127.0.0.1:4242/capture_payment_intent', {
    method: "POST",
    headers: {
      'Content-Type': 'application/json'
    },
